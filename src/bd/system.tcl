...
proc create_root_design { parentCell } {
  ...
  set AXI_Stream_Master [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 AXI_Stream_Master ]
...
CONFIG.ASSOCIATED_BUSIF {} \
  ...
  set clk_axi_50 [ create_bd_port -dir O -type clk clk_axi_50 ]
  set_property -dict [ list \
CONFIG.ASSOCIATED_BUSIF {S02_AXI:S01_AXI:S00_AXI} \
 ] $clk_axi_50
  ...
  set data_count_5 [ create_bd_port -dir O -from 9 -to 0 data_count_5 ]
  set data_count_6 [ create_bd_port -dir O -from 9 -to 0 data_count_6 ]
  set data_count_7 [ create_bd_port -dir O -from 9 -to 0 data_count_7 ]
...
CONFIG.NUM_PORTS {3} \
  ...
  connect_bd_intf_net -intf_net AXI_GammaCorrection_0_AXI_Stream_Master [get_bd_intf_ports AXI_Stream_Master] [get_bd_intf_pins AXI_GammaCorrection_0/AXI_Stream_Master]
  ...
  connect_bd_intf_net -intf_net FIFO_READ_2_1 [get_bd_intf_ports FIFO_READ_2] [get_bd_intf_pins fifo_generator_3/FIFO_READ]
  connect_bd_intf_net -intf_net FIFO_READ_3_1 [get_bd_intf_ports FIFO_READ_3] [get_bd_intf_pins fifo_generator_2/FIFO_READ]
  ...
  connect_bd_intf_net -intf_net FIFO_WRITE_2_1 [get_bd_intf_ports FIFO_WRITE_2] [get_bd_intf_pins fifo_generator_3/FIFO_WRITE]
  connect_bd_intf_net -intf_net FIFO_WRITE_3_1 [get_bd_intf_ports FIFO_WRITE_3] [get_bd_intf_pins fifo_generator_2/FIFO_WRITE]
  ...
  connect_bd_intf_net -intf_net S00_AXI_2 [get_bd_intf_ports S00_AXI] [get_bd_intf_pins axi_interconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net S01_AXI_2 [get_bd_intf_ports S01_AXI] [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net S02_AXI_2 [get_bd_intf_ports S02_AXI] [get_bd_intf_pins axi_interconnect_0/S02_AXI]
  ...
  connect_bd_net -net fifo_generator_2_data_count [get_bd_ports data_count_4] [get_bd_pins fifo_generator_2/data_count]
  connect_bd_net -net fifo_generator_3_data_count [get_bd_ports data_count_2] [get_bd_pins fifo_generator_3/data_count]
  connect_bd_net -net fifo_generator_4_data_count [get_bd_ports data_count_3] [get_bd_pins fifo_generator_4/data_count]
  ...
  connect_bd_net -net mm_clk_150 [get_bd_ports clk] [get_bd_pins AXI_BayerToRGB_1/StreamClk] [get_bd_pins AXI_GammaCorrection_0/StreamClk] [get_bd_pins MIPI_CSI_2_RX_0/video_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axis_s2mm_aclk] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins fifo_generator_0/clk] [get_bd_pins fifo_generator_1/clk] [get_bd_pins fifo_generator_2/clk] [get_bd_pins fifo_generator_3/clk] [get_bd_pins fifo_generator_4/clk] [get_bd_pins fifo_generator_5/clk] [get_bd_pins fifo_generator_6/clk] [get_bd_pins fifo_generator_7/clk] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins v_axi4s_vid_out_0/aclk]
  ...
  connect_bd_net -net rst_clk_wiz_0_50M_peripheral_aresetn [get_bd_ports rst_n] [get_bd_pins AXI_BayerToRGB_1/sStreamReset_n] [get_bd_pins AXI_GammaCorrection_0/aAxiLiteReset_n] [get_bd_pins AXI_GammaCorrection_0/sStreamReset_n] [get_bd_pins MIPI_CSI_2_RX_0/s_axi_lite_aresetn] [get_bd_pins MIPI_D_PHY_RX_0/s_axi_lite_aresetn] [get_bd_pins axi_apb_bridge_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_0_50M/peripheral_aresetn] [get_bd_pins v_axi4s_vid_out_0/aresetn] [get_bd_pins video_dynclk/s_axi_lite_aresetn] [get_bd_pins vtg/s_axi_aresetn]
  ...
  connect_bd_net -net s_axil_clk_50 [get_bd_ports clk_axi_50] [get_bd_pins AXI_GammaCorrection_0/AxiLiteClk] [get_bd_pins MIPI_CSI_2_RX_0/s_axi_lite_aclk] [get_bd_pins MIPI_D_PHY_RX_0/s_axi_lite_aclk] [get_bd_pins axi_apb_bridge_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_0/S02_ACLK] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_clk_wiz_0_50M/slowest_sync_clk] [get_bd_pins video_dynclk/s_axi_lite_aclk] [get_bd_pins vtg/s_axi_aclk]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs APB_M/Reg] SEG_APB_M_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AXI_GammaCorrection_0/AXI_Lite_Reg_Intf/Reg] SEG_AXI_GammaCorrection_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_CSI_2_RX_0/S_AXI_LITE/S_AXI_LITE_reg] SEG_MIPI_CSI_2_RX_0_S_AXI_LITE_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs MIPI_D_PHY_RX_0/S_AXI_LITE/S_AXI_LITE_reg] SEG_MIPI_D_PHY_RX_0_S_AXI_LITE_reg
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C40000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs video_dynclk/S_AXI_LITE/S_AXI_LITE_reg] SEG_video_dynclk_S_AXI_LITE_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C50000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs vtg/ctrl/Reg] SEG_vtg_Reg

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.6.5b  2016-09-06 bk=1.3687 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port FIFO_WRITE_5 -pg 1 -y 40 -defaultsOSRD
preplace port FIFO_READ_2 -pg 1 -y 1120 -defaultsOSRD
preplace port FIFO_WRITE -pg 1 -y 860 -defaultsOSRD
preplace port DDR -pg 1 -y 1540 -defaultsOSRD
preplace port FIFO_WRITE_6 -pg 1 -y 280 -defaultsOSRD
preplace port FIFO_READ_3 -pg 1 -y 180 -defaultsOSRD
preplace port dphy_hs_clock -pg 1 -y 2470 -defaultsOSRD
preplace port dphy_clk_lp_n -pg 1 -y 2510 -defaultsOSRD
preplace port S00_AXI -pg 1 -y 530 -defaultsOSRD
preplace port S02_AXI -pg 1 -y 570 -defaultsOSRD
preplace port FIFO_WRITE_7 -pg 1 -y 400 -defaultsOSRD
preplace port FIFO_READ_4 -pg 1 -y 1240 -defaultsOSRD
preplace port cam_gpio -pg 1 -y 1520 -defaultsOSRD
preplace port S01_AXI -pg 1 -y 550 -defaultsOSRD
preplace port FIFO_READ_5 -pg 1 -y 60 -defaultsOSRD
preplace port dphy_clk_lp_p -pg 1 -y 2490 -defaultsOSRD
preplace port FIFO_READ_6 -pg 1 -y 300 -defaultsOSRD
preplace port FIFO_READ_7 -pg 1 -y 420 -defaultsOSRD
preplace port FIFO_READ -pg 1 -y 880 -defaultsOSRD
preplace port S_AXIS_S2MM -pg 1 -y 1820 -defaultsOSRD
preplace port hdmi_tx -pg 1 -y 2120 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 1560 -defaultsOSRD
preplace port APB_M -pg 1 -y 2490 -defaultsOSRD
preplace port FIFO_WRITE_1 -pg 1 -y 980 -defaultsOSRD
preplace port clk_axi_50 -pg 1 -y 1420 -defaultsOSRD
preplace port clk -pg 1 -y 1310 -defaultsOSRD
preplace port FIFO_WRITE_2 -pg 1 -y 1100 -defaultsOSRD
preplace port cam_iic -pg 1 -y 1580 -defaultsOSRD
preplace port FIFO_WRITE_3 -pg 1 -y 160 -defaultsOSRD
preplace port AXI_Stream_Master -pg 1 -y 2320 -defaultsOSRD
preplace port FIFO_WRITE_4 -pg 1 -y 1220 -defaultsOSRD
preplace port FIFO_READ_1 -pg 1 -y 1000 -defaultsOSRD
preplace portBus data_count_1 -pg 1 -y 1000 -defaultsOSRD
preplace portBus dphy_data_hs_n -pg 1 -y 2550 -defaultsOSRD
preplace portBus data_count_2 -pg 1 -y 1120 -defaultsOSRD
preplace portBus data_count -pg 1 -y 880 -defaultsOSRD
preplace portBus data_count_3 -pg 1 -y 1240 -defaultsOSRD
preplace portBus dphy_data_hs_p -pg 1 -y 2530 -defaultsOSRD
preplace portBus data_count_4 -pg 1 -y 180 -defaultsOSRD
preplace portBus data_count_5 -pg 1 -y 60 -defaultsOSRD
preplace portBus data_count_6 -pg 1 -y 300 -defaultsOSRD
preplace portBus data_count_7 -pg 1 -y 420 -defaultsOSRD
preplace portBus dphy_data_lp_n -pg 1 -y 2590 -defaultsOSRD
preplace portBus dphy_data_lp_p -pg 1 -y 2570 -defaultsOSRD
preplace portBus rst_n -pg 1 -y 1740 -defaultsOSRD
preplace inst fifo_generator_3 -pg 1 -lvl 8 -y 1120 -defaultsOSRD
preplace inst v_axi4s_vid_out_0 -pg 1 -lvl 7 -y 2140 -defaultsOSRD
preplace inst fifo_generator_4 -pg 1 -lvl 8 -y 1240 -defaultsOSRD
preplace inst vtg -pg 1 -lvl 5 -y 2140 -defaultsOSRD
preplace inst axi_vdma_0 -pg 1 -lvl 5 -y 1870 -defaultsOSRD
preplace inst MIPI_D_PHY_RX_0 -pg 1 -lvl 4 -y 2570 -defaultsOSRD
preplace inst MIPI_CSI_2_RX_0 -pg 1 -lvl 5 -y 2420 -defaultsOSRD
preplace inst fifo_generator_5 -pg 1 -lvl 8 -y 60 -defaultsOSRD
preplace inst axi_mem_intercon_1 -pg 1 -lvl 7 -y 1610 -defaultsOSRD
preplace inst fifo_generator_6 -pg 1 -lvl 8 -y 300 -defaultsOSRD
preplace inst fifo_generator_7 -pg 1 -lvl 8 -y 420 -defaultsOSRD
preplace inst AXI_GammaCorrection_0 -pg 1 -lvl 8 -y 2320 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 6 -y 720 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 7 -y 1910 -defaultsOSRD
preplace inst rst_vid_clk_dyn -pg 1 -lvl 4 -y 1960 -defaultsOSRD
preplace inst rgb2dvi_0 -pg 1 -lvl 8 -y 2120 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 8 -y 650 -defaultsOSRD
preplace inst axi_apb_bridge_0 -pg 1 -lvl 8 -y 2490 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -y 2170 -defaultsOSRD
preplace inst fifo_generator_0 -pg 1 -lvl 8 -y 880 -defaultsOSRD
preplace inst video_dynclk -pg 1 -lvl 4 -y 2160 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -y 2390 -defaultsOSRD
preplace inst fifo_generator_1 -pg 1 -lvl 8 -y 1000 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 7 -y 1370 -defaultsOSRD
preplace inst AXI_BayerToRGB_1 -pg 1 -lvl 7 -y 2360 -defaultsOSRD
preplace inst fifo_generator_2 -pg 1 -lvl 8 -y 180 -defaultsOSRD
preplace inst rst_clk_wiz_0_50M -pg 1 -lvl 2 -y 2360 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 8 -y 1600 -defaultsOSRD
preplace netloc S00_AXI_2 1 0 8 NJ 530 NJ 530 NJ 530 NJ 530 NJ 530 NJ 530 NJ 530 NJ
preplace netloc axi_vdma_0_M_AXI_MM2S 1 5 2 NJ 1810 2050
preplace netloc dphy_hs_clock_1 1 0 4 NJ 2470 NJ 2470 NJ 2470 NJ
preplace netloc FIFO_READ_5_1 1 0 8 NJ 60 NJ 60 NJ 60 NJ 60 NJ 60 NJ 60 NJ 60 NJ
preplace netloc processing_system7_0_FIXED_IO 1 8 1 NJ
preplace netloc FIFO_WRITE_4_1 1 0 8 NJ 1220 NJ 1220 NJ 1220 NJ 1220 NJ 1220 NJ 1220 NJ 1220 NJ
preplace netloc axi_vdma_0_M_AXI_S2MM 1 5 2 NJ 1830 2060
preplace netloc dphy_clk_lp_p_1 1 0 4 NJ 2490 NJ 2490 NJ 2490 NJ
preplace netloc axi_vdma_0_s2mm_introut 1 5 2 NJ 1930 N
preplace netloc FIFO_READ_7_1 1 0 8 NJ 420 NJ 420 NJ 420 NJ 420 NJ 420 NJ 420 NJ 420 NJ
preplace netloc fifo_generator_1_data_count 1 8 1 NJ
preplace netloc ps7_0_axi_periph_M02_AXI 1 3 2 960 2060 NJ
preplace netloc dphy_data_hs_p_1 1 0 4 NJ 2530 NJ 2530 NJ 2530 NJ
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 6 2 NJ 740 2540J
preplace netloc axi_vdma_0_M_AXIS_MM2S 1 5 2 NJ 1850 2110
preplace netloc fifo_generator_0_data_count 1 8 1 NJ
preplace netloc ps7_0_axi_periph_M04_AXI 1 3 2 900 2370 NJ
preplace netloc FIFO_WRITE_5_1 1 0 8 NJ 40 NJ 40 NJ 40 NJ 40 NJ 40 NJ 40 NJ 40 NJ
preplace netloc xlconcat_0_dout 1 7 1 2480
preplace netloc rst_clk_wiz_0_50M_peripheral_aresetn 1 2 7 630 1740 910 1740 1340 1740 1720J 1740 2130 1740 2470 1740 NJ
preplace netloc FIFO_WRITE_2_1 1 0 8 NJ 1100 NJ 1100 NJ 1100 NJ 1100 NJ 1100 NJ 1100 NJ 1100 NJ
preplace netloc v_tc_0_vtiming_out 1 5 2 NJ 2120 2090
preplace netloc processing_system7_0_GPIO_0 1 8 1 NJ
preplace netloc MIPI_D_PHY_RX_0_RxByteClkHS 1 4 1 1390
preplace netloc ps7_0_axi_periph_M03_AXI 1 3 1 940
preplace netloc mm_clk_150 1 1 8 190 900 NJ 900 NJ 900 1370 900 NJ 900 2100 900 2520 1310 NJ
preplace netloc PixelClk_Generator_clk_out1 1 3 5 980 2050 1360 2000 NJ 2000 2120 2000 2490J
preplace netloc processing_system7_0_DDR 1 8 1 NJ
preplace netloc FIFO_READ_2_1 1 0 8 NJ 1120 NJ 1120 NJ 1120 NJ 1120 NJ 1120 NJ 1120 NJ 1120 NJ
preplace netloc S01_AXI_2 1 0 8 NJ 550 NJ 550 NJ 550 NJ 550 NJ 550 NJ 550 NJ 550 NJ
preplace netloc FIFO_READ_1_1 1 0 8 NJ 1000 NJ 1000 NJ 1000 NJ 1000 NJ 1000 NJ 1000 NJ 1000 NJ
preplace netloc FIFO_READ_4_1 1 0 8 NJ 1240 NJ 1240 NJ 1240 NJ 1240 NJ 1240 NJ 1240 NJ 1240 NJ
preplace netloc ref_clk_200 1 1 3 180 2610 NJ 2610 NJ
preplace netloc dphy_data_lp_n_1 1 0 4 NJ 2590 NJ 2590 NJ 2590 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 3 2 940 1800 NJ
preplace netloc S_AXIS_S2MM_1 1 0 5 NJ 1820 NJ 1820 NJ 1820 NJ 1820 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 8 200 1730 NJ 1730 960 1730 NJ 1730 NJ 1730 NJ 1730 NJ 1730 2950
preplace netloc dphy_clk_lp_n_1 1 0 4 NJ 2510 NJ 2510 NJ 2510 NJ
preplace netloc S02_AXI_2 1 0 8 NJ 570 NJ 570 NJ 570 NJ 570 NJ 570 NJ 570 NJ 570 NJ
preplace netloc AXI_GammaCorrection_0_AXI_Stream_Master 1 8 1 NJ
preplace netloc ps7_0_axi_periph_M01_AXI 1 3 1 N
preplace netloc axi_apb_bridge_0_APB_M 1 8 1 NJ
preplace netloc FIFO_READ_1 1 0 8 NJ 880 NJ 880 NJ 880 NJ 880 NJ 880 NJ 880 NJ 880 NJ
preplace netloc dphy_data_lp_p_1 1 0 4 NJ 2570 NJ 2570 NJ 2570 NJ
preplace netloc fifo_generator_3_data_count 1 8 1 NJ
preplace netloc axi_vdma_0_mm2s_introut 1 5 2 NJ 1910 N
preplace netloc processing_system7_0_IIC_0 1 8 1 NJ
preplace netloc FIFO_WRITE_7_1 1 0 8 NJ 400 NJ 400 NJ 400 NJ 400 NJ 400 NJ 400 NJ 400 NJ
preplace netloc fifo_generator_6_data_count 1 8 1 NJ
preplace netloc rst_clk_wiz_0_50M_interconnect_aresetn 1 2 5 610 1590 NJ 1590 NJ 1590 NJ 1590 2070
preplace netloc FIFO_WRITE_3_1 1 0 8 NJ 160 NJ 160 NJ 160 NJ 160 NJ 160 NJ 160 NJ 160 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 9 -70 1660 NJ 1660 NJ 1660 970 1660 NJ 1660 NJ 1660 2070J 2280 2540J 2220 2960
preplace netloc dphy_data_hs_n_1 1 0 4 NJ 2550 NJ 2550 NJ 2550 NJ
preplace netloc fifo_generator_4_data_count 1 8 1 NJ
preplace netloc FIFO_WRITE_1 1 0 8 NJ 860 NJ 860 NJ 860 NJ 860 NJ 860 NJ 860 NJ 860 NJ
preplace netloc clk_wiz_0_locked 1 1 1 200
preplace netloc MIPI_CSI_2_RX_0_m_axis_video 1 5 2 NJ 2420 2140
preplace netloc ps7_0_axi_periph_M06_AXI 1 3 5 920 2270 NJ 2270 NJ 2270 2050J 2470 NJ
preplace netloc v_tc_0_irq 1 5 2 NJ 2140 2080
preplace netloc v_axi4s_vid_out_0_locked 1 7 1 2480
preplace netloc axi_dynclk_0_LOCKED_O 1 3 2 990 2070 1320
preplace netloc MIPI_D_PHY_RX_0_D_PHY_PPI 1 4 1 1360
preplace netloc ps7_0_axi_periph_M05_AXI 1 3 5 930 2290 NJ 2290 NJ 2290 NJ 2290 NJ
preplace netloc fifo_generator_2_data_count 1 8 1 NJ
preplace netloc FIFO_READ_3_1 1 0 8 NJ 180 NJ 180 NJ 180 NJ 180 NJ 180 NJ 180 NJ 180 NJ
preplace netloc fifo_generator_7_data_count 1 8 1 NJ
preplace netloc v_axi4s_vid_out_0_vtg_ce 1 4 4 1390 2010 NJ 2010 NJ 2010 2460
preplace netloc axi_mem_intercon_1_M00_AXI 1 7 1 2480
preplace netloc rst_vid_clk_dyn_peripheral_aresetn 1 4 1 1350
preplace netloc rst_vid_clk_dyn_peripheral_reset 1 4 3 1390J 1990 NJ 1990 2060
preplace netloc rst_clk_wiz_0_50M_peripheral_reset 1 2 2 600J 2630 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 2 7 640 1750 NJ 1750 NJ 1750 NJ 1750 NJ 1750 NJ 1750 2970
preplace netloc FIFO_READ_6_1 1 0 8 NJ 300 NJ 300 NJ 300 NJ 300 NJ 300 NJ 300 NJ 300 NJ
preplace netloc FIFO_WRITE_1_1 1 0 8 NJ 980 NJ 980 NJ 980 NJ 980 NJ 980 NJ 980 NJ 980 NJ
preplace netloc FIFO_WRITE_6_1 1 0 8 NJ 280 NJ 280 NJ 280 NJ 280 NJ 280 NJ 280 NJ 280 NJ
preplace netloc rgb2dvi_0_TMDS 1 8 1 NJ
preplace netloc axi_mem_intercon_M00_AXI 1 7 1 2510
preplace netloc AXI_BayerToRGB_1_AXI_Stream_Master 1 7 1 2550
preplace netloc fifo_generator_5_data_count 1 8 1 NJ
preplace netloc s_axil_clk_50 1 1 8 180 590 620 590 950 590 1380 590 1720J 590 NJ 590 2500 1420 NJ
preplace netloc axi_dynclk_0_PXL_CLK_5X_O 1 4 4 1330J 2280 NJ 2280 2060J 2270 2530
preplace netloc v_axi4s_vid_out_0_vid_io_out 1 7 1 N
levelinfo -pg 1 -90 100 440 770 1160 1560 1890 2300 2750 3000 -top 0 -bot 2850
",
}
