...
* Generated by apb_slave_gen.pl on 25.03.19; 16:05
...
parameter CFG_SW_RST_ADDR = 16'h005C;
// END of automatically generated block of code 
...
parameter CFG_SW_RST_RST_VAL = 1'h0;
// END of automatically generated block of code 
...
// BEGIN of automatically generated block of code
 ...
 output [0:0] cfg_sw_rst;    // Software reset
// END of automatically generated block of code 
...
assign cfg_sw_rst_enable =  PSEL && (PADDR == CFG_SW_RST_ADDR);
// END of automatically generated block of code 
...
apb_reg_field_rw
  #(.WIDTH      (1),
    .RESET_VALUE(CFG_SW_RST_RST_VAL),
    .TP         (TP)
  ) i_apb_reg_field_rw_cfg_sw_rst(
    .PCLK    (PCLK),
    .PRESETn (PRESETn),
    .PWRITE  (PWRITE),
    .PWDATA  (PWDATA[0:0]),
    .PRDATA  (cfg_sw_rst_PRDATA),
    .enable  (cfg_sw_rst_enable),
    .sw_rst  (sw_rst),
    .data_out(cfg_sw_rst)
);
